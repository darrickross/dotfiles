...
{
  programs.bash = {
    # ignorespace + ignoredups is what bash calls "ignoreboth" — home-manager
    # only accepts the individual values, not the combined shorthand.
    # erasedups additionally removes older duplicates from the file.
    historyControl = [
      "ignorespace"
      "ignoredups"
      "erasedups"
